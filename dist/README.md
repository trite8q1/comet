...
- `comet.png` — 1024×1024 Comet app icon
...
installed builds can update into Comet. CI runs this on tags
...
2. Assemble the bundle:
   ...
   ```
3. Icon: generate `comet.icns` from `dist/macos/icon-1024.png` (the macOS-shaped
   ...
   ```sh
   mkdir comet.iconset && sips -z 256 256 dist/macos/icon-1024.png --out comet.iconset/icon_256x256.png
