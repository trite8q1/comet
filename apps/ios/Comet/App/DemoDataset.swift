...
final class DemoDataset {
    ...
    static func standard() -> DemoDataset {
        ...
        let comet = Space(id: "space-comet", deviceId: "dev-mac",
                          path: "/Users/dev/comet", name: nil, gitDetected: true,
        ...
        let chats = [
            Chat(id: "chat-veil", deviceId: "dev-mac", title: "Streaming veil on transcript rows",
                 archived: false, cwd: "/Users/dev/.comet/worktrees/comet-veil-fade",
    ...
    static let fileTree: [String: [String]] = [
        ...
        "/Users/dev/Projects": ["comet", "dotfiles", "blog", "playground"],
        "/Users/dev/Projects/comet": ["apps", "crates", "docs", "edge"],
    ...
    private static let repoNames: Set<String> = ["comet", "dotfiles", "blog", "playground", "edge", "landing"]
    ...
    func createWorktree(spacePath: String, base: String) -> String {
        ...
        let path = "/Users/dev/.comet/worktrees/\((spacePath as NSString).lastPathComponent)-\(slug)"
