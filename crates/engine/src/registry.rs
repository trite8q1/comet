...
pub fn default_registry() -> HarnessRegistry {
    ...
    registry.register_lazy(
        ...
        Box::new(|| comet_harness::ClaudeHarness::new().installed()),
    ...
    registry.register_lazy(
        ...
        Box::new(|| comet_harness::CodexHarness::new().installed()),
    ...
    registry.register_lazy(
        ...
        Box::new(|| comet_harness::CursorHarness::new().installed()),
        Box::new(|| Ok(Arc::new(comet_harness::CursorHarness::new()) as Arc<dyn Harness>)),
    );
    ...
    registry.register_lazy(
        ...
        Box::new(|| comet_harness::OpencodeHarness::new().installed()),
